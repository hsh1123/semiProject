...
<%
    ...
    if(mem==null){
    	...
    	int gradeCode = mem.getGradeCode();
...
<a _ngcontent-serverapp-c91="" class="btn btn-primary-soft text-primary btn-sm d-none d-sm-inline-block me-2" href="https://github.com/StartBootstrap/startbootstrap-sb-admin-2/archive/gh-pages.zip"><fa-icon _ngcontent-serverapp-c91="" class="ng-fa-icon me-1"><svg role="img" aria-hidden="true" focusable="false" data-prefix="fad" data-icon="download" class="svg-inline--fa fa-download fa-w-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><g class="fa-group"><path class="fa-secondary" fill="currentColor" d="M320 24v168h87.7c17.8 0 26.7 21.5 14.1 34.1L269.7 378.3a19.37 19.37 0 0 1-27.3 0L90.1 226.1c-12.6-12.6-3.7-34.1 14.1-34.1H192V24a23.94 23.94 0 0 1 24-24h80a23.94 23.94 0 0 1 24 24z"></path><path class="fa-primary" fill="currentColor" d="M488 352H341.3l-49 49a51.24 51.24 0 0 1-72.6 0l-49-49H24a23.94 23.94 0 0 0-24 24v112a23.94 23.94 0 0 0 24 24h464a23.94 23.94 0 0 0 24-24V376a23.94 23.94 0 0 0-24-24zm-120 96a16 16 0 1 1 16-16 16 16 0 0 1-16 16zm64 0a16 16 0 1 1 16-16 16 16 0 0 1-16 16z"></path></g></svg></fa-icon>Free Download</a>
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item <%=content.equals("logo") ? "active" : "" %>">
				<a class="nav-link collapsed" href="Main.jsp?content=logo">
					<i class="fas fa-fw fa-folder"></i> <span>Team FIVE</span>
			</a>
			...
			<!-- 오늘의게시판관리 -->
			<li
				class="nav-item <%=content.equals("admin/adminToda") ? "active" : "" %>">
