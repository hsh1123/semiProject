...
List<QnADTO> list = dao.getQnAList2(choice, search, pageNumber);
System.out.println("list.size()"+list.size());
int len = dao.getAllPageSearch(choice, search);
...
function searchBtn() {
	...
	location.href="Main.jsp?content=admin/adminQna&choice="+choice+"&search="+search; //검색했을 때 검색한 결과만 가지고페이지 갱신해야함
...
function goPage( pageNum ) {
	...
	let url = "Main.jsp?content=admin/adminQna&pageNumber=" + pageNum;
