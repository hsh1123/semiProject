...
List<TodayWeatherDTO> list = dao.getTodayWeatherPagingListSearch(pageNumber,choice,search);
System.out.println(list.size());
int len = dao.getAllTodayWeatherSearch(choice,search);
...
function searchBtn() {
	...
	location.href="Main.jsp?content=admin/adminToday&choice="+choice+"&search="+search; //검색했을 때 검색한 결과만 가지고페이지 갱신해야함
...
function goPage( pageNum ) {
	...
	let url = "Main.jsp?content=admin/adminToday&pageNumber=" + pageNum;
